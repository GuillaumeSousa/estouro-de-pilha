			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="vote.contributor.label" default="Contributor" /></th>
					
						<th><g:message code="vote.post.label" default="Post" /></th>
				...
				<g:each in="${voteInstanceList}" status="i" var="voteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${voteInstance.id}">${fieldValue(bean: voteInstance, field: "contributor")}</g:link></td>
					
						<td>${fieldValue(bean: voteInstance, field: "post")}</td>
