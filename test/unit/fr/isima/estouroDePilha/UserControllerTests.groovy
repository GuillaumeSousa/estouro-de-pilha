...
class UserControllerTests {
    ...
    def populateValidParams(params) {
        ...
        params["login"] = 'admin@groovyrocks.com'
		params["password"] = 'adminadmin'
		params["pseudo"] = 'admin'
		params["realName"] = 'Administrator'
		params["role"] = 'admin'
		params["birthDate"] = Date.parse("yyyy-MM-dd", "2000-01-01")
    }
    ...
    void testShow() {
        ...
        assert user.save(validate:false) != null
